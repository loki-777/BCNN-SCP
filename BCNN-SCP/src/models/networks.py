...
class BCNN(pl.LightningModule):
    def __init__(self, prior_kernel, prior_kernel_params,
                 ...
                 num_samples_training=1, num_samples_predict=1, kernel="RBF"):
        super(BCNN, self).__init__()
        priors = {
            "kernel": prior_kernel,
            "kernel_params": prior_kernel_params
        }
        self.conv1 = BBBConv2d(1, out_channels_conv1, filter_size=3, stride=1, padding=1, kernel=kernel, priors=priors)
        self.conv2 = BBBConv2d(out_channels_conv1, out_channels_conv2, filter_size=3, stride=1, padding=1, kernel=kernel, priors=priors)
