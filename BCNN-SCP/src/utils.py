...
def get_dataloaders(config):
    ...
    if config["data"]["dataset"] == "pneumonia":
        ...
        train_dataset = PneumoniaDataset(train_dataset_path, transform=transform)
        val_dataset = PneumoniaDataset(val_dataset_path, transform=transform)
        test_dataset = PneumoniaDataset(test_dataset_path, transform=transform)
